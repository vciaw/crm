...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="top_bg">
	<tr>
		<td class="top_left td_t_n td_r_n">当前位置：功能插件 > 考勤签到 > 安装</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
	  <col width="100" />
        ...
        <tr> 
			...
			<td class="td_r_l">上下班登记，查询考勤统计和导出考勤报表，可以设置时间</td>
        </tr>
        <tr> 
...
Sub setup02()	
	...
	Else
		conn.execute "insert into [Plugin](pTitle,pUrl,pAuthor,pVersion,pContent,pTime,pYn) values('考勤签到','Signin','易用科技','V2.0','包含上下班登记，考勤统计','"&now()&"','1')"
		if accsql=1 then
