...
function WebIM()
{
	...
	this.Common = {
		...
		{
			return ["在线","忙碌","马上回来","离开","通话中","外出就餐","显示为离线","注销"][n];
		},
		//根据OnlineStatus返回对应字符串
		getOnlineStatusStr:function(n)
		{
			return ["在线","忙碌","离开","离线"][n];
		},
		...
		showContextMenu:function(o,evt)
		{
			...
			if(parseInt(e.button)==2)//右键菜单
			{
				...
				if(uid)
				{
					...
					arr.add(u.CustomName==u.UserName?"修改备注姓名|_webIM.CMD.editCustomName("+uid+")":"修改备注姓名|_webIM.CMD.editCustomName("+uid+")");
	...
	this.Data = {
		...
		{
			return [["1","笑脸","/xl"],["2","撇嘴","/pz"],["3","色","/se"],["4","发呆","/fd"],["5","得意","/dy"],["6","流泪","/ll"],["7","含羞","/hx"],["8","闭嘴","/bz"],["9","睡","/shui"],["10","大哭","/dk"],["11","尴尬","/gg"],["12","发怒","/fn"],["13","调皮","/tp"],["14","龇牙","/zy"],["15","惊讶","/jy"],["16","难过","/ng"],["17","酷","/kuk"],["18","冷汗","/lengh"],["19","抓狂","/zk"],["20","吐","/tu"],["21","偷笑","/tx"],["22","可爱","/ka"],["23","白眼","/by"],["24","傲慢","/am"],["25","饥饿","/jie"],["26","困","/kun"],["27","惊恐","/jk"],["28","流汗","/lh"],["29","憨笑","/hanx"],["30","大兵","/db"],["31","奋斗","/fengd"],["32","咒骂","/zm"],["33","疑问","/yw"],["34","嘘...","/xu"],["35","晕","/yun"],["36","折磨","/zhem"],["37","衰","/shuai"],["38","骷髅","/kl"],["39","敲打","/qd"],["40","再见","/zj"],["41","擦汗","/ch"],["42","抠鼻","/kb"],["43","鼓掌","/gz"],["44","糗大了","/qdl"],["45","坏笑","/huaix"],["46","左哼哼","/zhh"],["47","右哼哼","/yhh"],["48","哈欠","/hq"],["49","鄙视","/bs"],["50","委屈","/wq"],["51","快哭了","/kkl"],["52","阴险","/yx"],["53","亲亲","/qq"],["54","吓","/xia"],["55","可怜","/kel"]];
		},
		//返回个人信息的User对象
	...
	this.CMD = {
		...
		intLoginWindow:function()
		{
			...
			w.LoadedCallback = function(id,t)
			{
				$("divStatusId6Type3").onclick = function(e)
				{
					...
					m.Data = ["在线|_webIM.CMD.changeLoginStatus(0)|images/m0.gif",
						...
						"离线|_webIM.CMD.changeLoginStatus(6)|images/m3.gif"];
					m.E = e;
					m.HasIcon = true;
					m.Width = 120;
					m.Top = w.Top+157;
		...
		{
			var w = new WebForm();
			w.Title = "<span style='color:#fff;padding-left:5px;'>内部聊天插件</span>";
			w.Icon = "defaulticon.gif";
			w.Type = 2;
			w.Height = 450;
			w.Width = 220;
					...
					var intInteralID = setInterval(
						function()
						{
							if(_me.Config&&_me.Profile&&_me.Group&&_me.Friend)
							{
								...
								{
									var m = new SysMenu("menuUserNameId"+id+"Type"+t);
									m.Data = ["在线|_webIM.CMD.changeUserStatus(0)|images/m0.gif",
											...
											"离线|_webIM.CMD.changeUserStatus(6)|images/m3.gif",
											"",
											//"注销|_webIM.CMD.logoutWebIM()|images/m3.gif"];
											"注销|_webIM.CMD.changeUserStatus(7)|images/m3.gif"];
									m.E = e;
									m.HasIcon = true;
									m.Width = 120;
									m.Top = w.Top+59;
								...
								{
									_me.Common.showLink(350,285,w.Top,w.Left<355?w.Left+w.Width+2:w.Left-352,1,"添加联系人","page/addfriend.asp?v="+Math.random(),"tooladdfriend.gif");
								};
								...
								$("wMainListTypeId"+id+"Type"+t).onclick = function(e)//添加联系人按钮
								{
									...
									m.Data = ["按状态排序|_webIM.CMD.renderMyFriend(1,_webIM.Config.DisType,true)",
											...
											//修改过这里 ,"显示详细信息|_webIM.CMD.renderMyFriend(_webIM.Config.OrderType,2,true)"
		...
		searchMyFriend:function(k)
		{
			...
			else
			{
				...
				{
					Elem.Value(obj,"<div class=\"wMainUserItemText\" style=\"padding:10px 0 0 10px;width:100%;\">无搜索结果</div>");
				}
			}
		},
		//填充好友列表
		renderMyFriend:function(orderType,disType,clearSearch)
		{
			...
			{
				_me.Common.addUserHeader(obj,"在线",0);
				_me.Common.addUserHeader(obj,"离线",1);
				var num = [0,0];
				for(var i=0;i<_me.Friend.length;i++)
				{
					var u = _me.Friend[i];
				...
				w.LoadedCallback = function(id,t)
					{
						...
						//修改 $("wChatSignId"+id+"Type"+t).innerHTML = u.UserSign+" &lt;"+u.UserEmail+">";
